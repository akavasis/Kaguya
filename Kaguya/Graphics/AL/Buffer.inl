...
Buffer::Buffer(const RenderDevice* pDevice, const Properties<T, UseConstantBufferAlignment>& Properties)
...
template<typename T, bool UseConstantBufferAlignment>
Buffer::Buffer(const RenderDevice* pDevice, const Properties<T, UseConstantBufferAlignment>& Properties, CPUAccessibleHeapType CPUAccessibleHeapType)
...
template<typename T, bool UseConstantBufferAlignment>
Buffer::Buffer(const RenderDevice* pDevice, const Properties<T, UseConstantBufferAlignment>& Properties, const Heap* pHeap, UINT64 HeapOffset)
